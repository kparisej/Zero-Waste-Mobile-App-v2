...
public class fragment_goodbye extends Fragment {
    ...
    private FragmentGoodbyeViewModel mViewModel;

    public static fragment_goodbye newInstance() {
        return new fragment_goodbye();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_goodbye_fragment, container, false);
    }
